%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function point 1 experiment(random monitoring) main script
...
for k=0:num_node    % the numbers of monitors from 0 to num_node
    ...
    for i=1:num_loops       % the external for loops
        ...
        second_node_info1 = second_node_info(1: second_node_info_len/2, :); % first half part
        second_node_info2 = second_node_info(second_node_info_len/2 + 1: second_node_info_len, :);  % second half part
        res_time_secnod = getSecondResTime(second_node_info1, second_node_info2);
