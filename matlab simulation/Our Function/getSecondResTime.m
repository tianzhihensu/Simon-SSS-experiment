function [ second_res_time ] = getSecondResTime( second_node_info1, second_node_info2, second_node_info3 )
...
%       second_node_info3: list of modes/edge that make up second phase.
%       notice: second_node_info1, second_node_info2 and second_node_info3 is parallel in
...
second_res_time3 = sum(second_node_info3(:, 1));
second_res_time = max([second_res_time1, second_res_time2, second_res_time3]);
end
